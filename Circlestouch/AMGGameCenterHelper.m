...
@implementation AMGGameCenterHelper
...
{
    if (!sharedHelper) {
        sharedHelper = [[AMGGameCenterHelper alloc] init];
    }
    return sharedHelper;
}
...
{
    GKScore *scoreReporter = [[GKScore alloc] initWithCategory:@"AMG.CirclestouchLeaderbord"];
